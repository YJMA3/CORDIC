...
HD_PWD='Z:/labs/cordic-finalversion/cordic-finalversion.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab8_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source lab8_top.tcl
