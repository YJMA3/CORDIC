...
input rst
  ...
  serial_addsub SA1 (addsub,x[0],yi,rst_bit,clk,xas);
  serial_addsub SA2 (~addsub,y[0],xi,rst_bit,clk,yas);
  serial_addsub SA3 (addsub,z[0],rt0,rst_bit,clk,zas);
