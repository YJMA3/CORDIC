...
HD_PWD='Z:/labs/cordic-finalversion/cordic-finalversion.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab8_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source lab8_top.tcl -notrace
